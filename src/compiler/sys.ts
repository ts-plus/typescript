    ...
    export let sys: System = (() => {
        ...
        function getNodeSystem(): System {
            ...
            const nodeSystem: System = {
                ...
                realpath,
                debugMode: !!process.env.TSPLUS_DEBUG || !!process.env.NODE_INSPECTOR_IPC || !!process.env.VSCODE_INSPECTOR_OPTIONS || some(process.execArgv as string[], arg => /^--(inspect|debug)(-brk)?(=\d+)?$/i.test(arg)),
