import {
    ...
    getContainingObjectLiteralElement, getDeclarationForTsPlus, getDirectoryPath, getEffectiveBaseTypeNode, getInvokedExpression,
    ...
    isAssignmentExpression, isBinaryExpression, isBinaryOperatorToken, isBindingElement, isCallExpression, isCallLikeExpression, isCallOrNewExpressionTarget, isClassElement,
    ...
    isNameOfFunctionDeclaration, isNewExpressionTarget, isObjectBindingPattern, isPropertyAccessExpression, isPropertyName,
    isRightSideOfPropertyAccess, isStaticModifier, isTsPlusSymbol, isTsPlusTypeWithDeclaration, isVariableDeclaration, last, map, mapDefined, ModifierFlags,
    ...
    textRangeContainsPositionInclusive, TextSpan, tryCast, tryGetModuleSpecifierFromDeclaration, TsPlusSymbolTag, Type, TypeChecker,
